...
///////////////////////////
        ...
        let localHour = parseInt(localTime.slice(11, 13));
        ...
        let bgImage =
          localHour >= 6 && localHour < 18 ? "day.jpg" : "night.jpg";
        ...
        setFirstTemp(
          res.data.forecast.forecastday[0].hour[(localHour + 1) % 24].temp_c +
            "°C"
        );
        setSecondTemp(
          res.data.forecast.forecastday[0].hour[(localHour + 2) % 24].temp_c +
            "°C"
        );
        setThirdTemp(
          res.data.forecast.forecastday[0].hour[(localHour + 3) % 24].temp_c +
            "°C"
        );
        setFourthTemp(
          res.data.forecast.forecastday[0].hour[(localHour + 4) % 24].temp_c +
            "°C"
        );
        setFifthTemp(
          res.data.forecast.forecastday[0].hour[(localHour + 5) % 24].temp_c +
            "°C"
        );
        setSixthTemp(
          res.data.forecast.forecastday[0].hour[(localHour + 6) % 24].temp_c +
            "°C"
        );

        setCurrent1(
          res.data.forecast.forecastday[0].hour[(hour + 1) % 24].condition.icon
        );
        setCurrent2(
          res.data.forecast.forecastday[0].hour[(hour + 2) % 24].condition.icon
        );
        setCurrent3(
          res.data.forecast.forecastday[0].hour[(hour + 3) % 24].condition.icon
        );
        setCurrent4(
          res.data.forecast.forecastday[0].hour[(hour + 4) % 24].condition.icon
        );
        setCurrent5(
          res.data.forecast.forecastday[0].hour[(hour + 5) % 24].condition.icon
        );
        setCurrent6(
          res.data.forecast.forecastday[0].hour[(hour + 6) % 24].condition.icon
        );
    ...
    <>
      <div id="navbar">
        ...
        <div>
          ...
          />
          <button onClick={checkWeather} id="btn">
            Check
          </button>
        </div>
      </div>
        ...
        >
          ...
          <div id="second">
            <div className="box">
              ...
              <p className="next-hour-time">{firstHour}</p>
              <p className="next-hour-temp">{firstTemp}</p>
            </div>

            <div className="box">
              
              <img src={current2} alt="" />
              <p className="next-hour-time">{secondHour}</p>
              <p className="next-hour-temp">{secondTemp}</p>
            </div>

            <div className="box">
              
              <img src={current3} alt="" />
              <p className="next-hour-time">{thirdHour}</p>
              <p className="next-hour-temp">{thirdTemp}</p>
            </div>

            <div className="box">
              
              <img src={current4} alt="" />
              <p className="next-hour-time">{fourthHour}</p>
              <p className="next-hour-temp">{fourthTemp}</p>
            </div>

            <div className="box">
              
              <img src={current5} alt="" />
              <p className="next-hour-time">{fifthHour}</p>
              <p className="next-hour-temp">{fifthTemp}</p>
            </div>

            <div className="box">
              
              <img src={current6} alt="" />
              <p className="next-hour-time">{sixthHour}</p>
              <p className="next-hour-temp">{sixthTemp}</p>
            </div>
          </div>
          </div>

          <div className="highlights">
            <p id="heading-2">Today's Highlights</p>
            <div id="third">
              <div className="box2">
                <p>Sunrise</p>
